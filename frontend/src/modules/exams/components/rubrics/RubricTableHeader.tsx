    ...
    <div className="bg-box backdrop-blur-sm border border-line rounded-xl p-6 space-y-4">
        ...
        <div className="border-t border-line pt-4 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-300">Competencia</label>
              <CompetencySelector
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-300">Nivel MCER</label>
              <MCERLevelSelector
                value={filters.level}
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-300">Tipo de Evaluación</label>
              <Select
      ...
      <div className="flex flex-wrap gap-2">
        <Button
          variant="outline"
          size="sm"
          className="bg-transparent border-line text-gray-400 hover:bg-line/50 text-xs"
        >
          Todas ({totalCount})
        </Button>
        <Button
