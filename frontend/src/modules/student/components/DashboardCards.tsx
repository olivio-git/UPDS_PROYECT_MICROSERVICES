            ...
            <div className="flex items-start justify-between mb-4">
                <div>
                    ...
                    <div className="space-y-1">
                        <p className="font-medium text-foreground/80">{exam.name}</p>
        ...
        <div className="bg-card rounded-2xl shadow-sm border border-border p-6">
            <div className="flex items-start justify-between mb-4">
                ...
                <div className="text-right">
                    ...
                    <div className="text-sm text-muted-foreground">Nivel {result.level}</div>
                </div>
            </div>
            
            <div className="grid grid-cols-2 gap-3 mb-4">
                {Object.entries(result.competencies).map(([skill, score]) => (
                    <div key={skill} className="bg-muted/50 rounded-lg p-3">
            ...
            <button
                ...
                className="w-full bg-muted text-foreground/80 py-2 rounded-lg text-sm font-medium hover:bg-muted/80 transition-colors"
            >
                Ver Detalles
            </button>
        </div>
            ...
            <div className="space-y-4">
                <div>
                    <div className="flex justify-between items-center mb-2">
                        <span className="text-sm font-medium text-foreground/80">Nivel Actual</span>
