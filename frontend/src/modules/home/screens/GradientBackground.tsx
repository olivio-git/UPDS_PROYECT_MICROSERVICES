...
const sizes = {
  sm:"bg-gradient-to-br from-slate-900/20 via-purple-900/10 to-slate-900 bg-[radial-gradient(ellipse_80%_80%_at_50%_-40%,rgba(120,119,198,0.3),rgba(255,255,255,0))]",
  md:"bg-gradient-to-br from-slate-900/20 via-purple-900/10 to-slate-900 bg-[radial-gradient(ellipse_80%_80%_at_50%_-30%,rgba(120,119,198,0.3),rgba(255,255,255,0))]",
  lg:"bg-gradient-to-br from-slate-900/20 via-purple-900/10 to-slate-900 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]",
  xl:"bg-gradient-to-br from-slate-900/20 via-purple-900/10 to-slate-900 bg-[radial-gradient(ellipse_80%_80%_at_50%_-10%,rgba(120,119,198,0.3),rgba(255,255,255,0))]",
  "2xl":"bg-gradient-to-br from-slate-900/20 via-purple-900/10 to-slate-900 bg-[radial-gradient(ellipse_80%_80%_at_50%_-0%,rgba(120,119,198,0.3),rgba(255,255,255,0))]"
};
...
const GradientBackground = ({
  ...
  return (
    <div
      className={`fixed top-0 -z-10 min-h-screen w-screen overflow-hidden  ${
        grid && theme === "dark" ? "bg-grid-pattern " : ""
    ...
    >
      ...
      {/* 
      <div
        className={`absolute inset-0 transition-opacity duration-1000 opacity-[0.05]`}
        style={{
