...
router.get('/:sessionId/resume', authMiddleware, searchRefs, (req, res, next) => controller.resumeExam(req, res, next));
router.get('/:sessionId/attempts', authMiddleware, searchRefs, (req, res, next) => controller.attempts(req, res, next));
// Active session detection (no sessionId needed)
router.get('/active-session', authMiddleware, searchRefs, (req, res, next) => controller.getActiveSession(req, res, next));
...
router.get('/:sessionId/adaptive/resume', authMiddleware, searchRefs, (req, res, next) => controller.resumeAdaptive(req, res, next));
